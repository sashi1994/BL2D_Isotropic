%ecriture inp
function Write_INP_Function_shell(nodes, elements, locked, Cloadx, Cloady, Dloadx, Dloady, material, epaisseur)
...
for i=1:size(elements,1)
    fprintf(fid,'%s\r\n',['     ',int2str(elements(i,1)),',  ',int2str(elements(i,2)),',  ',int2str(elements(i,3)),',  ',int2str(elements(i,4))]);
end
